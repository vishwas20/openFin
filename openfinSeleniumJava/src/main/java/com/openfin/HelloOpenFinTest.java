...
public class HelloOpenFinTest {
    ...
    public static void main(String[] args) throws Exception {
        ...
        System.setProperty("webdriver.chrome.driver", "C:\\Users\\vivek.mamgain\\Desktop\\hello-openfin-selenium-java-example-master\\release\\chromedriver.exe");
        //Runtime.getRuntime().exec("E:/hello-openfin-selenium-java-example-master/release/chromedriver.exe");
       Runtime.getRuntime().exec("C:\\Users\\vivek.mamgain\\Desktop\\hello-openfin-selenium-java-example-master\\release\\chromedriver.exe");
       
        ChromeOptions options = new ChromeOptions();
//        options.setBinary(new File("E:\\hello-openfin-selenium-java-example-master\\release\\RunOpenFin.bat"));
//        options.addArguments("--config=E:\\hello-openfin-selenium-java-example-master\\release\\app.json");
        
        //options.setBinary("E:\\hello-openfin-selenium-java-example-master\\release\\RunOpenFin.bat");
        options.setBinary("C:\\Users\\vivek.mamgain\\Desktop\\hello-openfin-selenium-java-example-master\\release\\RunOpenFin.bat");
        options.addArguments("--config=E:\\hello-openfin-selenium-java-example-master\\release\\app.json");
        
        //options.setBinary(new File("C:\\Users\\vivek.mamgain\\AppData\\Local\\OpenFin\\OpenFinRVM.exe"));
...
//        capabilities.setCapability(ChromeOptions.CAPABILITY,  options);
//        
//        remoteDriverURL ="http://localhost:8818/wd/hub";
